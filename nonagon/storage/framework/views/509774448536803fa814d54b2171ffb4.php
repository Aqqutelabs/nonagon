...
<body>
    <nav class="quipdeck-nav nav">
        <div class="logo-box">
            <img src="<?php echo e(asset('assets/img/dark.png')); ?>" alt="quipdeck logo">
        </div>
            ...
            <div class="row">
                <div class="col-lg-4 p-2">
                    <div class="journey-exp">
                        <img src="<?php echo e(asset('assets/img/frame/1.png')); ?>" alt="process 1">
                ...
                <div class="col-lg-4 p-2">
                    <div class="journey-exp">
                        <img src="<?php echo e(asset('assets/img/frame/2.png')); ?>" alt="process 1">
                        <h6>get matched</h6>
                ...
                <div class="col-lg-4 p-2">
                    <div class="journey-exp">
                        <img src="<?php echo e(asset('assets/img/frame/3.png')); ?>" alt="process 1">
        ...
        <div class="col-lg-12">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <img src="<?php echo e(asset('assets/img/why/main.png')); ?>" alt="" class="why-img">
                    <img src="<?php echo e(asset('assets/img/why/small.png')); ?>" alt="" class="why-small-img">
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h6 class="text-center quoted">
                        <img src="<?php echo e(asset('images/icon/quote.png')); ?>">
                    </h6>
        ...
        <div class="logo-trusted">
            <div class="marquee">
                <div class="marquee-track">
                    <img src="<?php echo e(asset('assets/img/companies/1.png')); ?>" alt="">
                    <img src="<?php echo e(asset('assets/img/companies/2.png')); ?>" alt="">
                    <img src="<?php echo e(asset('assets/img/companies/3.png')); ?>" alt="">
                    <img src="<?php echo e(asset('assets/img/companies/4.png')); ?>" alt="">
                    <img src="<?php echo e(asset('assets/img/companies/5.png')); ?>" alt="">
                    <img src="<?php echo e(asset('assets/img/companies/6.png')); ?>" alt="">
                    <img src="<?php echo e(asset('assets/img/companies/7.png')); ?>" alt="">
                    <img src="<?php echo e(asset('assets/img/companies/8.png')); ?>" alt="">
                    <img src="<?php echo e(asset('assets/img/companies/9.png')); ?>" alt="">
                    <img src="<?php echo e(asset('assets/img/companies/10.png')); ?>" alt="">
                    <img src="<?php echo e(asset('assets/img/companies/11.png')); ?>" alt="">
                    <img src="<?php echo e(asset('assets/img/companies/12.png')); ?>" alt="">
        ...
        <div class="footer-container">
            <div class="footer-content">
                ...
                <div class="footer-brand">
                    <div class="logo">
                        <img src="<?php echo e(asset('assets/img/light.png')); ?>" alt="">
                    </div>
...
<?php /**PATH C:\xampp\htdocs\nonagon\nonagon\resources\views/second.blade.php ENDPATH**/ ?>