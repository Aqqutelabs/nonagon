...
<header class="header wrap">
    ...
    <nav id="navigation" aria-label="Main navigation">
        ...
        <a class="nav-cta" href="#preview">Explore Nonagon <span aria-hidden="true">↗</span></a>
    </nav>
</header>
<main id="main">
    <section class="hero wrap">
        <div class="hero-copy">
            ...
            <div class="hero-actions"><a class="button" href="#preview">Explore the platform <span aria-hidden="true">↗</span></a><a class="text-link" href="#workflow">See how it works <span aria-hidden="true">↓</span></a></div>
    ...
    <section class="workflow section" id="workflow"><div class="wrap workflow-inner"><div><p class="eyebrow">A STRUCTURE THAT MAKES SENSE</p><h2>From the big picture<br>to the smallest detail.</h2><p>Mirror your real-world organization. Find equipment where it belongs and keep each team focused on its area of responsibility.</p></div><ol class="location-tree"><li><span>01</span> Organization</li><li><span>02</span> Base</li><li><span>03</span> Site</li><li><span>04</span> Plant</li><li><span>05</span> Unit <small>Your equipment, right where it belongs.</small></li></ol></div></section>
